...
void DisplayHelp()
{
    ...
    printf("stat : To dispay information of file using name\n");
...
void CloseFileByName(int fd)
{
    ...
    (UFDTArr[fd].ptrfiletable->ptrinode->RefrenceCount)--;
}
    ...
    while(1)
    {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"write") == 0)
            {
                ...
                if(ret == -2)
                    printf("ERROR : There is no sufficency memory to write\n");
                if(ret == -3)
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret == -1)
                    printf("ERROR : Incorrect Parameters\n");
                if(ret == -2)
                    printf("ERROR : There is no Inodesn\n");
                if(ret == -3)
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0)
                    printf("file is sucessfully opened with file desriptor : %d\n",ret);
                if(ret == -1)
                    printf("ERROR : Incorrect parameters\n");
                if(ret == -2)
